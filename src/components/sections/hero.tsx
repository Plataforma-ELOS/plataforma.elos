    ...
    <section className="relative w-full py-20 md:py-24 bg-gradient-to-b from-background to-primary/10 dark:to-primary/20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="relative grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          {/* Imagem decorativa posicionada absolutamente */}
          <div className="absolute top-1/2 -translate-y-1/2 right-0 w-[500px] h-[500px] hidden lg:block pointer-events-none -mr-16">
            <div
