...
export default function Hero() {
  return (
    <section className="relative w-full py-20 md:py-24 bg-gradient-to-b from-background to-primary/10 dark:to-primary/20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 z-10 relative">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          {/* A segunda coluna do grid fica vazia em telas grandes, o espaço será preenchido pela imagem posicionada absolutamente */}
          <div className="hidden lg:block" />
        </div>
      </div>
      {/* Imagem decorativa posicionada absolutamente em relação à seção */}
      <div className="absolute top-0 right-0 h-full w-1/2 lg:flex items-center justify-center hidden pointer-events-none">
        <div
          className="absolute w-[800px] h-[800px] top-1/2 -translate-y-1/2 right-0 translate-x-1/4"
          style={{
