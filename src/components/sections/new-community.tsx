...
const testimonials = [
  {
    name: 'Ana P.',
    avatar: '/home/lugar_ideal/depoimentos/depoimento-1.jpg',
    hint: 'woman portrait',
  ...
  {
    name: 'João M.',
    avatar: '/home/lugar_ideal/depoimentos/depoimento-2.jpg',
    hint: 'man portrait',
  ...
  {
    name: 'Carla F.',
    avatar: '/home/lugar_ideal/depoimentos/depoimento-3.jpg',
    hint: 'woman smiling',
  ...
  {
    name: 'Marcos R.',
    avatar: '/home/lugar_ideal/depoimentos/depoimento-4.jpg',
    hint: 'man smiling',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-8">
             ...
             <div className="pt-6">
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl bg-card border-primary/20 p-6 sm:p-10 rounded-3xl min-h-[420px] flex flex-col justify-between overflow-hidden">
                    <DialogHeader>
                      ...
                      >
                        <CarouselContent>
                          {testimonials.map((testimonial, index) => (
                            <CarouselItem key={index}>
                              <div className="text-center flex flex-col items-center justify-center h-full py-6 px-4 gap-4 relative select-none">
                        ...
                        <CarouselPrevious className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-background/50 border-none text-foreground/50 hover:bg-muted hover:text-foreground h-10 w-10" />
                        <CarouselNext className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-background/50 border-none text-foreground/50 hover:bg-muted hover:text-foreground h-10 w-10" />
                      </Carousel>
                  </DialogContent>
                </Dialog>
            </div>
          ...
          <div className="relative hidden lg:flex items-center justify-center w-full">
            <div className="relative w-full max-w-[380px] aspect-square rounded-2xl overflow-hidden shadow-xl border border-border">
               <Image
                src="/home/lugar_ideal/seulugar.jpg"
