// src/app/comunidade/explorar-grupos/client-page.tsx
"use client";
...
import { ArrowLeft, Users, Check, Plus, PartyPopper } from 'lucide-react';
...
export default function ExploreGroupsPageClient({ gruposIniciais }: { gruposIniciais: GroupCardData[] }) {
    const [groups, setGroups] = useState<GroupCardData[]>(gruposIniciais);
