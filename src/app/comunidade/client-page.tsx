// src/app/comunidade/client-page.tsx
"use client";
...
export default function CommunityPageClient({
  ...
  const handleCreatePost = async (content: string, imageUrl?: string) => {
    ...
    // Server Action já chama revalidatePath('/comunidade') — o refresh
    // busca os dados atualizados no servidor (posts sincronizam via o
    // useEffect acima) e exibe o post recém-criado com id/autor reais.
    router.refresh();
  };
            ...
            <div className="space-y-8 lg:sticky top-24">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {user ? (
                    <CreateEventDialog onCreated={() => router.refresh()} />
                  ) : (
                    <LoginRequiredDialog onConfirm={handleProtectedAction}>
